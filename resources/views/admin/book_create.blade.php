      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form id="form-wizard" class="form-horizontal" method="post" action="{{url('books')}}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-actions">
                <input id="next" class="btn btn-primary" type="submit" value="Add" />
                <div id="status"></div>
              </div>
